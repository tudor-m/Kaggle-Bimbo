...
mean_pred_cv[which(is.na(mean_pred_cv))] = 0.65*s_feat_cv_all[["A1"]][which(is.na(mean_pred_cv))]
mean_pred_cv[which(is.na(mean_pred_cv))] = 0.65*s_feat_cv_all[["G1"]][which(is.na(mean_pred_cv))]
mean_pred_cv[which(is.na(mean_pred_cv))] = 0.65*s_feat_cv_all[["AB1"]][which(is.na(mean_pred_cv))]
mean_pred_cv[which(is.na(mean_pred_cv))] = 0.65*s_feat_cv_all[["AA1"]][which(is.na(mean_pred_cv))]
